const message = () => {
    ...
    const information = ["Bravey Mahagia", "20 Years old", "Single", "Informatika", "Computer Science", "Asrama Crystal", "Penetration testing, Computer Security, Ethical Hacking"];
